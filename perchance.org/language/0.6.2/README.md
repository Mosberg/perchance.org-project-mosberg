...
Version **0.6.2** includes JSON-driven official plugin/template intelligence on top of colorful grammar, snippets, IntelliSense, hover docs, and navigation.

## What this version emphasizes

- Official plugin metadata from `data/official_plugins.json` used for import completions, hover docs, and validation.
- Workspace custom plugin metadata from `plugins.perchance.json` used for import completions, hover docs, and validation.
- Official templates metadata from `data/official_templates_generators.json` used for template URL completions and insertion command.
- Custom templates from `data/custom_templates.json` usable via quick command insertion.
...
- `data/official_plugins.json`
- `data/official_templates_generators.json`
...
- `perchance.completions.enableOfficialPlugins`
- `perchance.completions.enableCustomPlugins`
- `perchance.completions.enableTemplateLinks`
- `perchance.plugins.customPluginsFileName`
- `perchance.commands.enableTemplateInsertion`

## Commands

- `Perchance: Create Workspace Custom Plugins File`
- `Perchance: Insert Custom Template`
- `Perchance: Insert Official Template Link`
