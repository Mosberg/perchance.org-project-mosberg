...
- Added JSON-driven official plugin support using bundled `data/official_plugins.json`.
- Added JSON-driven official template link support using bundled `data/official_templates_generators.json`.
- Added bundled custom template support using `data/custom_templates.json`.
- Added workspace custom plugin support via `plugins.perchance.json` (file name configurable).
- Added command: `Perchance: Create Workspace Custom Plugins File`.
- Added import completions/hover metadata for official plugins.
- Added import completions/hover metadata for workspace custom plugins.
- Extended import diagnostics and typo quick fixes to account for official plugin names.
- Extended import diagnostics and typo quick fixes to account for workspace custom plugin names.
- Added command: `Perchance: Insert Custom Template`.
- Added command: `Perchance: Insert Official Template Link`.
